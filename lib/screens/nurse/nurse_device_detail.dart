...
class NurseDeviceDetailScreen extends StatefulWidget {
  final String deviceId;

  const NurseDeviceDetailScreen({
    super.key,
    required this.deviceId,
  });

  @override
  State<NurseDeviceDetailScreen> createState() => _NurseDeviceDetailScreenState();
}

class _NurseDeviceDetailScreenState extends State<NurseDeviceDetailScreen> {
  Device? _device;
